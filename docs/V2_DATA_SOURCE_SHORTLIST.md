...
| [CeyMo](https://github.com/oshadajay/CeyMo) | The official source provides 2,099 train images at 1,920 x 1,080 with polygon, box, and mask annotations for 11 kinds of road markings. | `Road_marking` | Object detection and road-marking-positive multi-label evidence; multi-class only after cross-condition review | **Downloaded and audited on 2026-09-13.** The structural audit passed with warnings, and the student approved the visible quality and marking examples. All 2,099 images are readable and contain 3,488 marking objects. Two exact duplicate pairs and three source-annotation warnings must be handled before splitting. The repository contains an MIT licence, but applicability to dataset-file redistribution must be confirmed before images are redistributed. |
...
| `Road_marking` | Available in the audited CeyMo training source. It supplies marking-presence evidence and 3,488 marking objects, but it has not yet been deduplicated or integrated into the V2 inventory. |
