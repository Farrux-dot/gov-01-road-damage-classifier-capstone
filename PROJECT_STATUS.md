...
- The source-traceable pre-split candidate inventory was rebuilt on 2026-09-19. It contains 13,956 records: 6,000 SVRDD source-training records, 624 eligible V1 training potholes, 1,241 GitHub pothole records, 1,721 eligible StreetSurfaceVis source-training records, 2,097 duplicate-safe CeyMo source-training records, 1,197 Hugging Face manhole-cover records, and 1,076 audited Kaggle source-training speed-bump records. See `docs/V2_CANDIDATE_INVENTORY.md` and `docs/v2_candidate_inventory.csv`.
...
- The inventory keeps all V1 validation/protected-test images, all SVRDD source validation/test images, all StreetSurfaceVis records marked `official_train=False`, the CeyMo official test package, and all 1,277 Kaggle speed-bump source-test images out of the candidate pool. It found zero exact SHA-256 duplicate groups across the 13,956 included records.
- Of the candidates, 9,338 have object boxes; 4,618 image-level candidates have no boxes and cannot support object detection without new box annotations. This includes V1 potholes, StreetSurfaceVis surfaces, Hugging Face manhole covers, and Kaggle speed bumps.
