...
- The source-traceable pre-split candidate inventory was rebuilt on 2026-09-17 after integration of the student-approved `jaygala24/pothole-detection` GitHub source. It contains 11,683 records: 6,000 SVRDD source-training records, 624 eligible V1 training potholes, 1,241 GitHub pothole records, 1,721 eligible StreetSurfaceVis source-training records, and 2,097 duplicate-safe CeyMo source-training records. See `docs/V2_CANDIDATE_INVENTORY.md` and `docs/v2_candidate_inventory.csv`.
...
- Of the candidates, 9,338 have object boxes; the 624 V1 pothole images and 1,721 StreetSurfaceVis images have image-level labels only and cannot support object detection without new box annotations.
