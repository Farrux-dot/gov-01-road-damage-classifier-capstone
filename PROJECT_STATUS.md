...
- The source-traceable pre-split candidate inventory was created on 2026-09-09 and expanded with StreetSurfaceVis and CeyMo on 2026-09-13. It contains 10,551 records: 6,000 SVRDD source-training records, 624 eligible V1 training potholes, 109 individually approved PaveBench detection records, 1,721 eligible StreetSurfaceVis source-training records, and 2,097 duplicate-safe CeyMo source-training records. See `docs/V2_CANDIDATE_INVENTORY.md` and `docs/v2_candidate_inventory.csv`.
- The inventory keeps all V1 validation/protected-test images, all SVRDD source validation/test images, all StreetSurfaceVis records marked `official_train=False`, and the CeyMo official test package out of the candidate pool. It found zero exact SHA-256 duplicate groups across the 10,551 included records.
- Of the candidates, 8,206 have object boxes; the 624 V1 pothole images and 1,721 StreetSurfaceVis images have image-level labels only and cannot support object detection without new box annotations.
...
- StreetSurfaceVis was integrated into the source-traceable pre-split inventory on 2026-09-13. The unclear record `SSV-055` and every `official_train=False` record were excluded. At that stage the inventory contained 8,454 records: 6,000 SVRDD, 624 V1 training potholes, 109 individually approved PaveBench records, and 1,721 StreetSurfaceVis records (791 normal asphalt and 930 unpaved road).
...
- The combined inventory now contains 10,551 records: 6,000 SVRDD, 624 V1 training potholes, 109 individually approved PaveBench records, 1,721 StreetSurfaceVis records, and 2,097 CeyMo records. Exact SHA-256 checking finds zero duplicate groups among included records.
