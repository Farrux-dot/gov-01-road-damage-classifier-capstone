...
- The V2 fine-tuned MobileNetV2 candidate is locked at threshold `0.50` after validation-only threshold selection. The next step is one protected-test evaluation; no further V2 training or tuning is allowed afterward.
- V2 protected-test evaluation was completed once after candidate lock: Macro F1 `0.479668`, pothole recall `0.841121`, and no-pothole recall `0.258278`. The model produces too many false pothole alerts to deploy. V2 test is closed; no further V2 tuning is allowed.
