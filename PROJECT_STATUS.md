...
- V2 naive and unweighted-CNN validation references were run. The CNN had Macro F1 `0.408163` and pothole recall `0.0`, exactly matching the naive majority rule; it is rejected. The next controlled V2 experiment is class weighting, using training labels only.
